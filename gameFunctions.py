...
def checkEvents(setting, screen, stats, sb, playBtn, quitBtn, menuBtn, sel, ship, aliens, bullets, eBullets):
    ...
    for event in pg.event.get():
        ...
        if event.type == pg.QUIT:
            ...
            checkKeydownEvents(event, setting, screen, stats, sb, playBtn, quitBtn, menuBtn, sel, ship, aliens, bullets,
                               eBullets, pauseBtnState)
            if (stats.gameActive):
                continue
            if event.key == pg.K_UP:
                ...
                if pauseBtnState == 1:
                    ...
                    pg.time.delay(300)
                    sys.exit()
                elif pauseBtnState == 4:
                    stats.mainMenu = False
                    stats.mainGame = False
                    stats.twoPlayer = False
                    stats.mainAbout = False
                    stats.settingsMenu = True
                    sel.rect.centery = 412
                    stats.resetStats()
                    pauseBtnState = 1
                    # Check if the key has been released
        elif event.type == pg.KEYUP:
            checkKeyupEvents(event, setting, screen, stats, sb, playBtn, quitBtn, menuBtn, sel, ship, aliens, bullets, eBullets,
                             pauseBtnState)
...
def checkKeydownEvents(event, setting, screen, stats, sb, playBtn, quitBtn, menuBtn, sel, ship, aliens, bullets, eBullets,
                       pauseBtnState):
...
def checkKeyupEvents(event, setting, screen, stats, sb, playBtn, quitBtn, menuBtn, sel, ship, aliens, bullets, eBullets,
                     pauseBtnState):
...
def updateScreen(setting, screen, stats, sb, ship, aliens, bullets, eBullets, playBtn, menuBtn, quitBtn, setBtnbtn, sel):
    """Update images on the screen and flip to the new screen"""
    # Redraw the screen during each pass through the loop
    # Fill the screen with background color
    # Readjust the quit menu btn position
    global x, clock, FPS
    setBtnbtn.rect.y = 350
    setBtnbtn.msgImageRect.y = 350
    quitBtn.rect.y = 300
